...
| **Skype for Business Standalone Installer**<br><a href="{get_package_detail(packages, 'Skype', 'update_download')}" style="text-decoration: none;"><small>_Release Notes_</small></a>  | `{get_package_detail(packages, 'Skype', 'short_version')}` | com.microsoft.SkypeForBusiness | <a href="https://go.microsoft.com/fwlink/?linkid=832978"><img src="images/skype_for_business.png" alt="Download Image" width="80"></a> |
